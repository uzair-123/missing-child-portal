...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    if (isset($_GET['delete']) && (int)$_GET['delete'] > 0){
        $query2 = "delete from forum where for_id= '".(int)$_GET['delete']."' ";
        $conn->query($query2);
                        ...
                        if($result = $conn->query($query))
                        {
                         ...
                         ?>
                            ...
                            <tr class="odd gradeX">
                                    ...
                                    <td><a class="btn btn-primary" href="forumu.php?delete=<?php echo $row['for_id']; ?>">  <i class="fa fa-trash" aria-hidden="true"></i></a></td>
