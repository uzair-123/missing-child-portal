...
$query = "update user set password = '$pass', username = '$user' where user_id = '1' " ;
if($conn->query($query))
{
    echo "<script type='text/javascript'>alert('YOUR INFO HAS BEEN CHANGED !!! ');</script>";
}
...
<legend><span class="number">1</span>CHANGE INFO</legend>
                   ...
                   <div>
                  <label><strong>Password </strong>(leave it empty, if not changing it)</label>
