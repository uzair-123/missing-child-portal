...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    if (isset($_GET['delete']) && (int)$_GET['delete'] > 0){
        $query2 = "delete from customers where cus_id= '".(int)$_GET['delete']."' ";
        $conn->query($query2);
...
float: right;
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="form.php?logout=1" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
