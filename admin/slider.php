...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    if (isset($_GET['delete']) && (int)$_GET['delete'] > 0){
        $query2 = "delete from slider where sl_id= '".(int)$_GET['delete']."' ";
        $conn->query($query2);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "Insert into slider(slname) VALUES ('$im')";
                ...
                <div class="row">
                 ...
                 <hr />
                        ...
                        <form action="slider.php" method="post" enctype="multipart/form-data">
                            ...
                            <input style="margin-bottom: 30px" type="submit" value="Upload Slider" name="submit" class="sub">
                        ...
                        if($result = $conn->query($query))
                        {
                         ...
                         ?>
                            ...
                            <tr class="odd gradeX">
                                            ...
                                            <td >
                                    <img style="height: 100px; width:100px" src="sliders/<?php echo $row['slname'] ?>"></td>

                                    <td><a class="btn btn-primary" href="slider.php?delete=<?php echo $row['sl_id']; ?>">  <i class="fa fa-trash" aria-hidden="true"></i></a></td>
