...
if(isset($_POST['post']))
{
 ...
 if(empty($msg) || empty($sbj))
{
	echo "<script type='text/javascript'>alert('Message Send Failed !!! Either subject or message is empty');</script>";
}
...
else
{
  $id = $_SESSION['ada'] ;
	...
	$query = "insert into message(message,user_id,subject) values('$msg','$id','$sbj')";
			...
			<div class="agile-form">
				<form action="" method="post" enctype= "multipart/form-data">
              	...
              	<li>
							...
							<input type="text" name="sbj" required>
							</div>
						</li>
					...
					<input type="submit" value="SEND MESSAGE" name="post">
				</form>	
			</div>
		</div>
</div>
