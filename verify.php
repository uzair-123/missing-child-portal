		...
		<div class="container_1">
			...
			<div class="agile-form">
				<form action="" method="post">
					<ul class="field-list">
						<li>
							<label class="form-label"> 
								 Enter Verification Code That Is Sent On Your Email
					...
					<input type="submit" value="Verify" name="posti">
				</form>	
			</div>
		</div>
</div>
...
$query = "insert into person(p_name,p_gender,p_phone,p_address,p_email,password,p_lname,city,province) values('$name', '$gender' , '$phone', '$address', '$email','$password','$name1','$city','$province')";

$conn->query($query) ;

echo "<script type='text/javascript'>alert('Your Account Has Been Registered !!!');</script>";
...
echo "<script type='text/javascript'>alert('Verification Failed, Sign Up Again !!!');</script>";
