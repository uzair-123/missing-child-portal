...
try {
    ...
    $mail->Username = 'uzairkamdar484@gmail.com';                           // Your gmail id
    $mail->Password = 'uzair123@';                           // Your gmail password
    $mail->SMTPSecure = 'tls';        // Enable TLS encryption, `ssl` also accepted

    $mail->Port = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('uzairkamdar484@gmail.com', '123456');
					...
					<ul class="field-list">
						<li>
                         ...
                         <div class="form-group">
							   <label for="company" style="margin-right: 50px">
    <span>First Name</span>
   	<input  type="text" name="name" 
								  value="<?php if(!empty($name)) echo $name ?>" placeholder="" id="idy" required ><span class="form-required" > <?php if(!empty($nameErr)) echo '*'.$nameErr;?></span>
...
<input value="<?php if(!empty($phone)){ echo $phone; } ?>" type="text" name="phone" placeholder="03xxxxxxxxx" maxlength="11"  required ><span class="form-required" > <?php if(!empty($phone_err)) echo '*'.$phone_err;?></span>
  </label>
...
<input placeholder="Enter Steet Address" value="<?php if(!empty($address)){echo $address;} ?>" type="text" name="address"  >
...
<input value="<?php if(!empty($email)){echo $email;} ?>" type="email" name="email" placeholder="myname@example.com" required>
								...
								<li> 
                                 ...
                                 <label for="company" style="margin-right: 50px">
    <span>Password</span>
						<input value="" type="password" name="password" placeholder="" required>  </label>
    ...
    <span>Confirm Password</span>
					...
					<input style="margin-top: 100px; margin-left: 60px" type="submit" value="Register" name="register">
				</form>	
			</div>
		</div>
</div>
